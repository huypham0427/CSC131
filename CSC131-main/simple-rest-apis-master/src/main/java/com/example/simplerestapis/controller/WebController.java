...
public class WebController {
	...
	// Get the reading from the csv file (Buffer Reader) in another file
	// inside the loop - split and fill out the array
	// Make movie object - title and year in RequestMapping
	// Return movie object looks like the SampleResponse
	// http://localhost:8080/movie/categories?name=bestpicture
